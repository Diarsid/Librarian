...
public final class PatternToWordMatchingV24 extends LoggingInScript implements PatternToWordMatchingCodeV1 {
    ...
    //                              /* V21.1 */   }
        ...
        if ( STRICT && matchType == PATTERN_IS_WORD_FRAGMENT ) {
            if ( notFound < 2 ) {
        ...
        if ( STRICT && lengthRatioType == LENGTHS_APPROX_EQUAL ) {
        ...
        switch ( matchLength ) {
            ...
            case 5:
                ...
                else if ( STRICT || matchType == WORD_IS_PATTERN_FRAGMENT ) {
                    requiredFullMatches = 3;
                    requiredPatternMatches = 3;
                }
                else {
