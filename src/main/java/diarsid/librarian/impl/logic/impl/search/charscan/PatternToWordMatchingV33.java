...
public final class PatternToWordMatchingV33 extends LoggingInScript implements PatternToWordMatchingCodeV2 {
...
//        }
        ...
        logln("  order:%s, found:%s, match-span:%s, full-matches:%s, pattern-matches:%s (s:%s w:%s), back-matches:%s, typo-matches:%s, w-diff:%s, p-diff:%s, 0-ch-miss:%s, 1-ch-miss:%s", order, found, matchSpan, matchFull, matchInPattern, matchInPatternStrong, matchInPatternWeak, backwardMatches, typoMatches, diffInWordSum, diffInPatternSum, firstCharMissed, secondCharMissed);
