...
import static diarsid.librarian.impl.logic.impl.jdbc.h2.extensions.H2AggregateFunctionForAnalyzeV27.RejectionReason.FIRST_CHAR_FOUND_FROM_SINGLE_CHAR_MATCHES_BUT_1_OR_2_CHARS_MISSED;
import static diarsid.librarian.impl.logic.impl.jdbc.h2.extensions.H2AggregateFunctionForAnalyzeV27.RejectionReason.NO_WORDS;
import static diarsid.librarian.impl.logic.impl.jdbc.h2.extensions.H2AggregateFunctionForAnalyzeV27.RejectionReason.PATTERN_START_NOT_FOUND_AND_MANY_WORDS;
import static diarsid.librarian.impl.logic.impl.jdbc.h2.extensions.H2AggregateFunctionForAnalyzeV27.RejectionReason.PATTERN_START_NOT_FOUND_AND_ONE_WORD;
import static diarsid.librarian.impl.logic.impl.jdbc.h2.extensions.H2AggregateFunctionForAnalyzeV27.RejectionReason.PATTERN_TOO_SMALL_TO_HAVE_MISSED_CHARS;
import static diarsid.librarian.impl.logic.impl.jdbc.h2.extensions.H2AggregateFunctionForAnalyzeV27.RejectionReason.TOO_MUCH_MISSED;
import static diarsid.librarian.impl.logic.impl.jdbc.h2.extensions.H2AggregateFunctionForAnalyzeV27.RejectionReason.TOO_MUCH_SPACES_AND_MISSED_IN_WORDS;
import static diarsid.librarian.impl.logic.impl.jdbc.h2.extensions.H2AggregateFunctionForAnalyzeV27.RejectionReason.TOO_MUCH_SPACES_IN_WORDS;
import static diarsid.librarian.impl.logic.impl.jdbc.h2.extensions.H2AggregateFunctionForAnalyzeV27.RejectionReason.WORDS_DEDUPLICATED_MEANINGFUL_LENGTH_SUM_TOO_SMALL;
import static diarsid.librarian.impl.logic.impl.jdbc.h2.extensions.H2AggregateFunctionForAnalyzeV27.RejectionReason.WORDS_DEDUPLICATED_TOTAL_LENGTH_SUM_TOO_SMALL;
import static diarsid.librarian.impl.logic.impl.jdbc.h2.extensions.H2AggregateFunctionForAnalyzeV27.RejectionReason.WORDS_MEANINGFUL_LENGTH_SUM_TOO_SMALL;
import static diarsid.librarian.impl.logic.impl.jdbc.h2.extensions.H2AggregateFunctionForAnalyzeV27.RejectionReason.WORDS_TOTAL_LENGTH_SUM_TOO_SMALL;

public class H2AggregateFunctionForAnalyzeV27 implements AggregateFunction {
    ...
    public void add(Object arg) throws SQLException {
            ...
            for ( int i = argMatchIndex; i < matchEnd; i++) {
                ...
                if ( matchType == FISRT_CHAR_MATCH_TYPE ) {
                    ...
                    if ( position == NON_FILLED_POSITION ) {
                        ...
                        if ( matchType == MOVABLE_MATCH_TYPE ) {
                            movableOverlapsInWord++;
                        }
                    } else if ( position < WORD_SPACE_POSITION-1 ) {
        ...
        if ( rollbackWordApplying ) {
            ...
            overlapsMovable = overlapsMovable + movableOverlapsInWord;
            words++;
...
//            return format("words:%s rate%s overlap:%s missed:%s", wordsCount, rateSum, overlap, missed);
    ...
    public int overlapsMovable() {
        return overlapsMovable;
    }
