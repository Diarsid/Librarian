...
public final class PatternToWordMatchingCode {
    ...
    public static long evaluate(String pattern, String word) {
        return evaluateV19(pattern, word);
    }

    private static long evaluateV18(String pattern, String word) {
...
//                                    mismatches++;
        ...
        if ( mismatches == 0 && found > 2 ) {
            ...
            if ( found == matchInPattern && order == found && backwardMatches == 0 ) {
                ...
                if ( patternMatchLength == found ) {
                    ...
                    if ( patternMatchLength - found <= accepted ) {
    ...
    private static long evaluateV19(String pattern, String word) {
        //logln("p:%s --- w:%s", pattern, word);
