...
public final class PatternToWordMatchingV56 extends PatternToWordMatchingCodeV2 {
...
//        }
        ...
        if ( rate >= threshold ) {
            ...
            if ( found == 2 && wordLength < 6 && patternStartsWithWord && matchFull == 0 && matchInPatternStrong == 0 ) {
