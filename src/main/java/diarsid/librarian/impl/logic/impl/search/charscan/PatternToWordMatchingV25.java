...
public final class PatternToWordMatchingV25 extends LoggingInScript implements PatternToWordMatchingCodeV1 {
    ...
    //                              /* V21.1 */   }
        ...
        int total;
        if ( matchFull > 2 || matchInPatternStrong > matchFull + 1 ) {
            total = matchFull * 10
        ...
        if ( matchFull > 0 && matchFull < 3 && (matchInPattern - matchFull) > 1 && backwardMatches == 0 && matchInPatternWeak > 0 ) {
